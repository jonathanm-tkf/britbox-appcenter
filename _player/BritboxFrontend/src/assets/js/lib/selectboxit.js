...
(function(selectBoxIt) {
  ...
  function($, window, document, undefined) {
    ...
    $.widget('selectBox.selectBoxIt', {
      ...
      _createDropdownButton: function() {
        ...
        self.dropdown = $('<span/>', {
          ...
          class:
            ...
            ' ' +
            (self.selectBox.prop('disabled') ? self.theme['disabled'] : self.theme['enabled']),
      ...
      _replaceSelectBox: function() {
        var self = this,
          ...
          listSize = (self.listSize =
            size === undefined ? 'auto' : size === '0' || 'size' === 'auto' ? 'auto' : +size),
        ...
        self.dropdownText.css({
          'max-width':
            self.dropdownContainer.outerWidth(true) - (downArrowContainerWidth + dropdownImageWidth)
        });
      ...
      _addClasses: function(obj) {
        ...
        self.downArrow.addClass(
          self.selectBox.attr('data-downarrow') || self.options['downArrowIcon'] || arrowClass
        );
    ...
    selectBoxIt.add = function(data, callback) {
      this._populate(data, function(data) {
        ...
        if (
          (data &&
            (dataType === 'array' ||
              (isJSON && parsedJSON.data && $.type(parsedJSON.data) === 'array'))) ||
    ...
    selectBoxIt._addAttributes = function(arr, elem) {
      ...
      if (arr.length) {
        ...
        $.each(arr, function(iterator, property) {
          ...
          if (
            propValue !== 'null' &&
            ($.inArray(propName, whitelist) !== -1 || propName.indexOf('data') !== -1)
          ) {
      ...
      // If the `size` option is not a number
        ...
        var listOffsetTop = self.dropdown.offset().top,
          ...
          viewportScrollTop = $.isWindow(viewport.get(0))
            ...
            : viewport.offset().top,
          topToBottom =
            listOffsetTop + selectBoxHeight + listHeight <= viewportHeight + viewportScrollTop,
    ...
    selectBoxIt.moveDown = function(callback) {
      ...
      var disabled =
          self.listItems.eq(self.currentFocus).attr('data-disabled') === 'true' ? true : false,
        hasNextEnabled = self.listItems
          .eq(self.currentFocus)
          .nextAll('li')
          .not("[data-disabled='true']")
    ...
    selectBoxIt._searchAlgorithm = function(currentIndex, alphaNumeric) {
      var self = this,
        ...
        numSearchCharacters =
          $.type(options.numSearchCharacters) === 'number' ? options.numSearchCharacters : 3;
