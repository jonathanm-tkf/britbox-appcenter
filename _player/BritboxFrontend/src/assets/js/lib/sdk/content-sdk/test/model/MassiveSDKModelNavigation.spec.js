...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxContentApi10.MassiveSDKModelNavigation();
  });
  ...
  describe('MassiveSDKModelNavigation', function() {
    it('should create an instance of MassiveSDKModelNavigation', function() {
      // uncomment below and update the code to test MassiveSDKModelNavigation
      //var instane = new BritboxContentApi10.MassiveSDKModelNavigation();
      //expect(instance).to.be.a(BritboxContentApi10.MassiveSDKModelNavigation);
    });
