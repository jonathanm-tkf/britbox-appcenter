...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxContentApi10.MassiveSDKModelContinueWatchingListData();
  });
  ...
  describe('MassiveSDKModelContinueWatchingListData', function() {
    it('should create an instance of MassiveSDKModelContinueWatchingListData', function() {
      ...
      //var instane = new BritboxContentApi10.MassiveSDKModelContinueWatchingListData();
      //expect(instance).to.be.a(BritboxContentApi10.MassiveSDKModelContinueWatchingListData);
    });
