...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxContentApi10.MassiveSDKModelNavEntry();
  });
  ...
  describe('MassiveSDKModelNavEntry', function() {
    it('should create an instance of MassiveSDKModelNavEntry', function() {
      // uncomment below and update the code to test MassiveSDKModelNavEntry
      //var instane = new BritboxContentApi10.MassiveSDKModelNavEntry();
      //expect(instance).to.be.a(BritboxContentApi10.MassiveSDKModelNavEntry);
    });
