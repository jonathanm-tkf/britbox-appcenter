...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxSearchApi10.MassiveSDKModelOffer();
  });
  ...
  describe('MassiveSDKModelOffer', function() {
    it('should create an instance of MassiveSDKModelOffer', function() {
      ...
      //var instane = new BritboxSearchApi10.MassiveSDKModelOffer();
      //expect(instance).to.be.a(BritboxSearchApi10.MassiveSDKModelOffer);
    });
