...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxSearchApi10.MassiveSDKModelTheme();
  });
  ...
  describe('MassiveSDKModelTheme', function() {
    it('should create an instance of MassiveSDKModelTheme', function() {
      ...
      //var instane = new BritboxSearchApi10.MassiveSDKModelTheme();
      //expect(instance).to.be.a(BritboxSearchApi10.MassiveSDKModelTheme);
    });
