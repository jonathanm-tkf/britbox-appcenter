...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxSearchApi10.MassiveSDKModelMedia();
  });
  ...
  describe('MassiveSDKModelMedia', function() {
    it('should create an instance of MassiveSDKModelMedia', function() {
      ...
      //var instane = new BritboxSearchApi10.MassiveSDKModelMedia();
      //expect(instance).to.be.a(BritboxSearchApi10.MassiveSDKModelMedia);
    });
