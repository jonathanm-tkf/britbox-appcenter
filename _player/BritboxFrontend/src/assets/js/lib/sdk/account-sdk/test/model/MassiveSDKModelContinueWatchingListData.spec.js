...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxAccountApi10.MassiveSDKModelContinueWatchingListData();
  });
  ...
  describe('MassiveSDKModelContinueWatchingListData', function() {
    it('should create an instance of MassiveSDKModelContinueWatchingListData', function() {
      ...
      //var instane = new BritboxAccountApi10.MassiveSDKModelContinueWatchingListData();
      //expect(instance).to.be.a(BritboxAccountApi10.MassiveSDKModelContinueWatchingListData);
    });
