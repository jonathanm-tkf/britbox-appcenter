...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxAccountApi10.BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse();
  });
  ...
  describe('BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse', function() {
    it('should create an instance of BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse', function() {
      // uncomment below and update the code to test BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse
      //var instane = new BritboxAccountApi10.BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse();
      //expect(instance).to.be.a(BritboxAccountApi10.BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse);
    });
