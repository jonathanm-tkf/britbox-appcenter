...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxAccountApi10.DeviceApi();
  });
  ...
  describe('DeviceApi', function() {
    describe('generateDeviceActivationCode', function() {
      it('should call generateDeviceActivationCode successfully', function(done) {
        //uncomment below and update the code to test generateDeviceActivationCode
        //instance.generateDeviceActivationCode(function(error) {
