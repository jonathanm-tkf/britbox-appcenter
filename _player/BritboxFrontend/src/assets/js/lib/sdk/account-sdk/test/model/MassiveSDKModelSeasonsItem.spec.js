...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxAccountApi10.MassiveSDKModelSeasonsItem();
  });
  ...
  describe('MassiveSDKModelSeasonsItem', function() {
    it('should create an instance of MassiveSDKModelSeasonsItem', function() {
      ...
      //var instane = new BritboxAccountApi10.MassiveSDKModelSeasonsItem();
      //expect(instance).to.be.a(BritboxAccountApi10.MassiveSDKModelSeasonsItem);
    });
