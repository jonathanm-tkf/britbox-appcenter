...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BritboxAccountApi10.BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse = factory(root.BritboxAccountApi10.ApiClient, root.BritboxAccountApi10.BritboxDataEvergentModelsFailureMessage);
  }
  ...
  /**
   * The BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse model module.
   * @module model/BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse</code>.
   * @alias module:model/BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse} obj Optional instance to populate.
   * @return {module:model/BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse} The populated <code>BritboxDataEvergentModelsAuthenticateCustomerResponseMessageBaseResponse</code> instance.
   */
