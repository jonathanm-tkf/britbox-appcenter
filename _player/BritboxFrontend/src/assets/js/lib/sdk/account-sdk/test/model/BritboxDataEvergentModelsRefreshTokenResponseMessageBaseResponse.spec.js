...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BritboxAccountApi10.BritboxDataEvergentModelsRefreshTokenResponseMessageBaseResponse();
  });
  ...
  describe('BritboxDataEvergentModelsRefreshTokenResponseMessageBaseResponse', function() {
    it('should create an instance of BritboxDataEvergentModelsRefreshTokenResponseMessageBaseResponse', function() {
      // uncomment below and update the code to test BritboxDataEvergentModelsRefreshTokenResponseMessageBaseResponse
      //var instane = new BritboxAccountApi10.BritboxDataEvergentModelsRefreshTokenResponseMessageBaseResponse();
      //expect(instance).to.be.a(BritboxAccountApi10.BritboxDataEvergentModelsRefreshTokenResponseMessageBaseResponse);
    });
