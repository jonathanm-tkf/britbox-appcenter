...
const SignUpSubscription = ({ screenProps: { theme } }: Props) => {
  ...
  const activeRadio = { backgroundColor: theme.SECONDARY_COLOR, borderColor: theme.SECONDARY_COLOR };
        ...
        <KeyboardAvoidingView style={flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          <ScrollView bounces={false}>
            <Container>
              ...
              <RowWrapper>
                <RadioBox onPress={() => setPackageName('monthly')} style={packageName == 'monthly' && activeRadio}>
                  <SubTitle style={textLeft}>Monthly</SubTitle>
                  <DescriptionText style={textLeft}>$6.99 per month</DescriptionText>
                </RadioBox>
                <RadioBox onPress={() => setPackageName('annual')} style={packageName == 'annual' && activeRadio}>
                  <SubTitle style={textLeft}>Annual</SubTitle>
                  <DescriptionText style={[textLeft, { marginBottom: 0 }]}>$69.99 per month</DescriptionText>
                  <RadioBottomText style={[textLeft, { marginTop: 5 }]}>12 months for the price of 10</RadioBottomText>
                </RadioBox>
              </RowWrapper>
              <RadioBottomText>
              ...
              <Paragraph>
                Please tap 'Start free trial' button to proceed with payment for your Subscription, so you can start enjoying BritBox.
              </Paragraph>
              <SmallText>
                Total
              </SmallText>
              ...
              <DescriptionText>
                per month after free trial ends
              </DescriptionText>
              <Button
                onPress={() => { }}
                stretch
              ...
              <Button outline size="big" style={cancelStyle} onPress={() => navigation.navigate('Login')}>
            ...
            <Wrapper>
              ...
              <Paragraph>
                Available from noon-midnight EST
              </Paragraph>
              <EmailTitle>
                support-us@britbox.com
              </EmailTitle>
            </Wrapper>
          </ScrollView>
